...
<fieldset>
    ...
    <br><label><b>Phone_no</b></label>
    <form:input type="phoneno" path="phoneno" value="${userdata.phoneno}" /><br>
    <br><label><b>Address</b></label>
    <form:input type="address" path="address" value="${userdata.address}" /><br>
